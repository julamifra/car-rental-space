"""
Django settings for djando_car_rental_space project.
...
ALLOWED_HOSTS = ['django-car-rental-space.herokuapp.com']
...
ROOT_URLCONF = 'djando_car_rental_space.urls'
...
WSGI_APPLICATION = 'djando_car_rental_space.wsgi.application'
